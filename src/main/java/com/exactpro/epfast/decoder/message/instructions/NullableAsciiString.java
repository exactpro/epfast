...
public class NullableAsciiString extends PrimitiveInstruction<DecodeNullableAsciiString> {

    public NullableAsciiString(Reference fieldName) {
        super(fieldName, new DecodeNullableAsciiString());
    }
